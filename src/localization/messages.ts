...
const enUsMessages: MessageCatalog = {
  ...
  "parse.timeline.clock.exact": "Exact eDPS/aDPS clock",
  "parse.timeline.clock.unavailable": "eDPS/aDPS clock unavailable",
  "parse.timeline.note.rdps_buckets": "{label} uses exact server-published adjusted-damage buckets; missing buckets are never replaced with ordinary damage. Cumulative rDPS uses the published active-combat clock, not wall time.",
  ...
  "parse.timeline.note.clock_unavailable": "Time-local eDPS, aDPS, and cumulative rDPS are unavailable because no complete reducer-authored rate clock was published; wall time is not substituted.",
