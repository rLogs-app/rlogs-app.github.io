...
const enUsMessages: MessageCatalog = {
  ...
  "parse.timeline.lanes.coverage.one": "Recorded lanes include exact skill uses, complete status lifecycles, deaths, and loadout changes from the public timeline only. 1 event was omitted from publication.",
  "parse.timeline.lanes.coverage.other": "Recorded lanes include exact skill uses, complete status lifecycles, deaths, and loadout changes from the public timeline only. {omitted} events were omitted from publication.",
  "parse.timeline.lanes.coverage_complete": "Recorded lanes include exact skill uses, complete status lifecycles, deaths, and loadout changes from the public timeline only.",
